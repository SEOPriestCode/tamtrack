    ...
    <div>
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fadeInUp">Contact Us</h1>
            ...
            <div className="animate-fadeInRight">
              ...
              <div className="space-y-8 mb-8">
                <div className="flex items-start space-x-4 group">
                  <div className="bg-gradient-to-br from-primary-500 to-primary-600 p-4 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">+234 806 317 7773</p>
                    <p className="text-gray-600 leading-relaxed">+234 806 317 7773</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">tech@tamtrack.ng</p>
                    <p className="text-gray-600 leading-relaxed">pierre.dina@tamtrack.ng</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">Monday - Friday: 8:00 AM - 6:00 PM</p>
              ...
              <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-8 rounded-2xl shadow-xl">
                <h3 className="font-semibold text-gray-900 mb-3 text-xl">Emergency Support</h3>
                ...
                <p className="text-primary-600 font-bold text-2xl">+234 806 317 7773</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12 text-left">
              <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                <h3 className="font-semibold text-gray-900 mb-3 text-lg">How quickly can you implement fleet tracking?</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                <h3 className="font-semibold text-gray-900 mb-3 text-lg">Do you offer training for our team?</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                <h3 className="font-semibold text-gray-900 mb-3 text-lg">What areas of Nigeria do you cover?</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                <h3 className="font-semibold text-gray-900 mb-3 text-lg">Can I try the system before committing?</h3>
                <p className="text-gray-600 leading-relaxed">
