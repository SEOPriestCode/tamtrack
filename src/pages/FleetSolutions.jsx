    ...
    <div>
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fadeInUp">Fleet Solutions</h1>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Industry-Specific Solutions</h2>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Vehicle Types We Manage</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {vehicleTypes.map((vehicle, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 text-center group">
                <div className="bg-gradient-to-br from-primary-500 to-primary-600 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <vehicle.icon className="h-10 w-10 text-white" />
                </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Our Fleet Management Process</h2>
            </div>
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center group">
                <div className="bg-gradient-to-br from-primary-500 to-primary-600 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">1</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Assessment</h3>
                <p className="text-gray-600 leading-relaxed">We analyze your current fleet operations and identify improvement opportunities. 20+ years of assessment expertise.</p>
              </div>
              <div className="text-center group">
                <div className="bg-gradient-to-br from-primary-500 to-primary-600 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">2</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Customization</h3>
                <p className="text-gray-600 leading-relaxed">We tailor our solutions to match your specific industry requirements and goals. Proven customization methodologies.</p>
              </div>
              <div className="text-center group">
                <div className="bg-gradient-to-br from-primary-500 to-primary-600 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">3</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Implementation</h3>
                <p className="text-gray-600 leading-relaxed">Our team handles installation, setup, and training for seamless integration. Smooth deployments guaranteed.</p>
              </div>
              <div className="text-center group">
                <div className="bg-gradient-to-br from-primary-500 to-primary-600 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold shadow-lg group-hover:scale-110 transition-transform duration-300">4</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Support</h3>
                <p className="text-gray-600 leading-relaxed">Ongoing support and optimization to ensure continuous improvement. 24/7 dedicated support team.</p>
              </div>
            </div>
          </div>
        </div>
